...
class TierLabels {
    constructor() {
        ...
        this.labels.set(/^Fest-/, "Uberfest and Epicfest units. Very good and very rare. Should be prioritized. Fest's 'F' tier is 'A' for others. Number means priority within Fest's banners");
